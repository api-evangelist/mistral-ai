...
**URL:** [Visit APIs.json URL](https://raw.githubusercontent.com/api-evangelist/mistral-ai/refs/heads/main/apis.yml)
...
## Tags:
 ...
 - Artificial Intelligence, Large Language Models, Chat, Embeddings, Fine-Tuning, OCR, Agents, Batch Processing
...
#### Tags:
 ...
 - Artificial Intelligence, Chat, Completions, Large Language Models, Conversational AI

#### Properties

- [Documentation](https://docs.mistral.ai/api/endpoint/chat)
- [OpenAPI](openapi/mistral-ai-chat-completions-openapi.yml)
...
#### Tags:
 ...
 - Artificial Intelligence, Embeddings, Vector Search, Semantic Search

#### Properties

- [Documentation](https://docs.mistral.ai/capabilities/embeddings)
- [OpenAPI](openapi/mistral-ai-embeddings-openapi.yml)
...
#### Tags:
 ...
 - Artificial Intelligence, Agents, Agentic Workflows, Automation, Orchestration

#### Properties

- [Documentation](https://docs.mistral.ai/api/endpoint/agents)
- [OpenAPI](openapi/mistral-ai-agents-openapi.yml)
...
#### Tags:
 ...
 - Artificial Intelligence, Fine-Tuning, Model Training, Machine Learning, Customization

#### Properties

- [Documentation](https://docs.mistral.ai/api/endpoint/fine-tuning)
- [OpenAPI](openapi/mistral-ai-fine-tuning-openapi.yml)
...
#### Tags:
 ...
 - Artificial Intelligence, OCR, Document AI, Text Extraction, PDF Processing

#### Properties

- [Documentation](https://docs.mistral.ai/api/endpoint/ocr)
- [OpenAPI](openapi/mistral-ai-ocr-openapi.yml)
...
#### Tags:
 ...
 - Artificial Intelligence, Models, Model Management, Infrastructure

#### Properties

- [Documentation](https://docs.mistral.ai/api/endpoint/models)
- [OpenAPI](openapi/mistral-ai-models-openapi.yml)
...
#### Tags:
 ...
 - Artificial Intelligence, Model Training, Pre-Training, Reinforcement Learning, Enterprise AI, Agentic Workflows

#### Properties

- [Documentation](https://mistral.ai/news/forge)
- [OpenAPI](openapi/mistral-ai-forge-openapi.yml)
...
#### Tags:
 ...
 - Artificial Intelligence, Batch Processing, Asynchronous, Large Scale

#### Properties

- [Documentation](https://docs.mistral.ai/capabilities/batch)
- [OpenAPI](openapi/mistral-ai-batch-openapi.yml)
